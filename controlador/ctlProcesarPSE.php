...
$day=date('Y-m-d H:i:s');
  ...
  //dotos para la clase resuesta
    $objRes=new clsRespuesta();  
    $objRes->setUsuario_id($usuarioId); 
    $objRes->setRef_venta($ref_venta); 
    $objRes->setValor($precio); 
    $objRes->setMoneda($moneda);
    $objRes->setEstado_pol($estado_pol); 
    $objRes->setIdentificacion($identificacionP);
    $objRes->setDay($day);

   //se crea la referencia del pago
  $insertId = $objRes->guardar($conex); 
  $refVenta = "INS-".$insertId;
  $actRef_venta = "INS-".$insertId;
  $objRes=new clsRespuesta();  
  $objRes->setInsertId($insertId); 
  $objRes->setActRef_venta($actRef_venta); 
  $objRes->actualizar($conex); 


  $firma = md5($key."~".$usuarioId."~".$refVenta."~".$precio."~".$moneda);
  //$baseDevolucionIva =  $precio /1.16;
...
Tu proceso de admisión en línea se realizó satisfactoriamte, por favor comunícate con nosotros para continuar con el proceso.
                ...
                <div class="jarviswidget jarviswidget-sortable" id="widget-id-0" role="widget" style=""> 
                  ...
                  <div role="content">
                    ...
                    <div class="inner-spacer"> 
                      <!-- content goes here -->
                      <form id="wizard"  name="wizard" class="themed" action="https://gateway2.pagosonline.net/apps/gateway/index.html" method="post">
                        <div id="wizard_name">
                        <div class="centered"> 
                          <!-- wizard steps -->
                                      ...
                                      <div style="display:none">
                                        <label class="radio inline">
                                              ...
                                              <div class="radio" id="uniform-optionsRadios4">
                                                <span class="">
                                                  <input type="radio" name="tipoPago" id="tipoPago" value="inscripción"  onclick="mostrar()" checked="" >
                                                </span>
                                              </div>
                                              Inscripción
                                              </label>
                                              ...
                                              <div class="radio" id="uniform-optionsRadios5">
                                                <span class="checked">
                                                  <input type="radio" name="tipoPago" id="tipoPago" value="matrícula" onclick="matricula()" >
                                                </span>
                                              </div>
                                              Matrícula
                                              </label>
                                              ...
                                              <div class="form-actions wizard">
                                                <div  align="center">
                                                  <ul style="list-style: none;">
                                                    ...
                                                    <div class="control-group franja-gris">
                                                    <div class="centered">
                                                     <label class="control-label" for="name">Factura</label> 
                                                                         

                                                    
                                                  
                                                 <input type="hidden" id="usuarioId" name="usuarioId" value="<?php echo $usuarioId; ?>">
                                                     <input class="span12"  type="text" id="refVenta" name="refVenta" value="<?php echo $refVenta; ?>" readonly>
                                                     <input type="hidden" id="descripcion" name="descripcion" value="<?php echo $descripcion; ?>">
                                                     <input type="hidden" id="baseDevolucionIva" name="baseDevolucionIva" value="<?php echo $baseDevolucionIva; ?>">
                                                     <input type="hidden" id="iva" name="iva" value="<?php echo $iva; ?>" >
                                                     <label class="control-label" for="name">Valor de la Inscripción</label> 

                                                     <input class="span12"  type="text" id="valor" name="valor" value="<?php echo $precio; ?>" readonly>
                                                     <input type="hidden" id="moneda" name="moneda" value="<?php echo $moneda; ?>">
                                                     <label class="control-label" for="name">Confirme su email</label>  
                                                     <input class="span12" type="text" id="emailComprador" name="emailComprador" value="<?php echo $emailComprador; ?>">
                                                     <input type="hidden" name="firma"  id="firma" value="<?php echo $firma; ?>" />
                                                     <input type="hidden" name="prueba" id="prueba" value="1" />
                                                     <button class="btn medium btn-primary next" type="sybmit" id="enviar" ><img src="../img/pse.png">Pagar</button><br>
